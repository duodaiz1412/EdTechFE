...
const INSTRUCTOR_ENDPOINTS = {
  ...
  UPDATE_BATCH: (batchId: string) => BASE_API + `/instructor/batches/${batchId}`,
  DELETE_BATCH: (batchId: string) => BASE_API + `/instructor/batches/${batchId}`,
  GET_MY_BATCHES: BASE_API + "/instructor/my-batches",
  GET_BATCH_BY_ID: (batchId: string) => BASE_API + `/instructor/batches/${batchId}`,
  PUBLISH_BATCH: (batchId: string) => BASE_API + `/instructor/batches/${batchId}/publish`,
...
export const instructorServices = {
  ...
  async getLessonBySlug(slug: string, accessToken?: string) {
    ...
    const response = await axios.get(INSTRUCTOR_ENDPOINTS.GET_LESSON_BY_SLUG(slug), { headers });
    return response;
  },
  ...
  async addQuestionsToQuiz(quizId: string, questions: any[], accessToken: string) {
    ...
    const normalized = (questions || []).map((q: any) => {
      ...
      const optionsString = optionsIsArray ? JSON.stringify(q.options) : q?.options ?? undefined;
  ...
  async updateQuestion(questionId: string, questionData: any, accessToken: string) {
    const response = await axios.put(
  ...
  async addInstructorToCourse(courseId: string, instructorId: string, accessToken: string) {
    const response = await axios.post(
  ...
  async removeInstructorFromCourse(courseId: string, instructorId: string, accessToken: string) {
    const response = await axios.delete(
      INSTRUCTOR_ENDPOINTS.REMOVE_INSTRUCTOR_FROM_COURSE(courseId, instructorId),
      { headers: { Authorization: `Bearer ${accessToken}` } },
    );
    return response;
  },
  ...
  async updateBatch(batchId: string, batchData: IBatchRequest, accessToken: string) {
    const response = await axios.put(
  ...
  async addInstructorToBatch(batchId: string, instructorId: string, accessToken: string) {
    const response = await axios.post(
  ...
  async removeInstructorFromBatch(batchId: string, instructorId: string, accessToken: string) {
    const response = await axios.delete(
...
export class InstructorService {
  ...
  static async updateChapter(
    ...
    return instructorServices.updateChapter(chapterId, chapterData, accessToken);
  }
  ...
  static async addQuestionsToQuiz(quizId: string, questions: any[], accessToken: string) {
    return instructorServices.addQuestionsToQuiz(quizId, questions, accessToken);
  }

  static async updateQuestion(questionId: string, questionData: any, accessToken: string) {
    return instructorServices.updateQuestion(questionId, questionData, accessToken);
  }
  ...
  // Course Instructor Management APIs
  static async addInstructorToCourse(courseId: string, instructorId: string, accessToken: string) {
    return instructorServices.addInstructorToCourse(courseId, instructorId, accessToken);
  }

  static async removeInstructorFromCourse(courseId: string, instructorId: string, accessToken: string) {
    return instructorServices.removeInstructorFromCourse(courseId, instructorId, accessToken);
  }
  ...
  static async updateBatch(batchId: string, batchData: IBatchRequest, accessToken: string) {
  ...
  static async addInstructorToBatch(batchId: string, instructorId: string, accessToken: string) {
    return instructorServices.addInstructorToBatch(batchId, instructorId, accessToken);
  }

  static async removeInstructorFromBatch(batchId: string, instructorId: string, accessToken: string) {
    return instructorServices.removeInstructorFromBatch(batchId, instructorId, accessToken);
  }
}
