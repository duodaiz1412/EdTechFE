...
import { PresignedUrlRequest, PresignedUrlResponse, TranscodeRequest, Job } from "../../types/upload.types";
 ...
 */
export const generatePresignedUrl = async (request: PresignedUrlRequest): Promise<PresignedUrlResponse> => {
  try {
