        ...
        <div className="min-w-[400px] space-y-3">
          ...
          >
             <div className="flex items-center justify-between">
               <span>
                 {uploadedUrl ? "Uploaded successfully" : selectedFile ? selectedFile.name : `Choose ${isImage ? "an image" : "a video"}`}
               </span>
               {uploadedUrl && (
          ...
          {selectedFile && !uploadedUrl && (
            ...
            >
              {uploadHook.isUploading ? "Uploading..." : `Upload ${isImage ? "Image" : "Video"}`}
            </Button>
          )}
