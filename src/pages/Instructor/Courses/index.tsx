...
export default function InstructorCourse() {
  ...
  const {state: courseState, getMyCourses, deleteCourse, clearError} = useCourseHook();
  ...
  const loadCourses = useCallback(async () => {
    try {
      ...
      const transformedCourses: Course[] = coursesData.map(course => ({
        ...
        publishedAt: course.status === "PUBLISHED" ? new Date(course.updatedAt).toLocaleDateString() : undefined,
      }));
