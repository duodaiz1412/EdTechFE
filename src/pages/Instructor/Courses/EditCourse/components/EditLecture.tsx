...
export default function EditLecture() {
  ...
  return (
    <div className="p-6">
        ...
        onClick={() => navigate(`/instructor/courses/${courseId}/edit/curriculum`)}
      >
        ← Back to curriculum
      </button>
      ...
      <div className="bg-white border rounded-lg p-6 max-w-3xl mx-auto">
        ...
        <div>
          <div className="flex flex-row items-center gap-1 h-fit">
            ...
            <span className="text-md text-red-500 align-top justify-center">*</span>
          </div>
            ...
            {isUploading && progress && (
              <div className="mt-3">
                <div className="flex justify-between text-sm text-gray-600 mb-1">
                  ...
                  <span>{Math.round(progress.loaded / 1024)}KB / {Math.round(progress.total / 1024)}KB</span>
                </div>
        ...
        {showContent && (
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <Button
              type="submit"
              disabled={!formik.isValid || !formik.values.title.trim() || isUploading || isSubmitting}
              className="bg-gray-800 text-white hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isUploading ? "Uploading..." : isSubmitting ? "Creating..." : "Save"}
            </Button>
          </div>
        </form>
      </div>
