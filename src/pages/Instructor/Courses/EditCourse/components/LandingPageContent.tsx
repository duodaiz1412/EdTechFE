...
export default function LandingPageContent() {
  ...
  const addSubject = () => {
    if (newSubject.trim() && !formData.label.some(label => label.name === newSubject)) {
      updateFormData({
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Add tags to help students discover your course (at least 1 required)
            </p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              What you primarily taught in this course? <span className="text-red-500">*</span>
            </label>
            <div className="flex flex-wrap gap-2 mb-3">
